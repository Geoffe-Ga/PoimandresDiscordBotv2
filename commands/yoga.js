...
const commandName = 'yoga';                                   //<----SET THE command name to be  the same as this file's name.js
...
module.exports = {
	...
	data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('part')
                .setDescription('Pāda#.sūtra#')                   //<----SET THE DESCRIPTION (How is the book divided?)
                .setRequired(true)),
	...
	async execute(interaction) {
        ...
        if (undefined !== bookRef[bookPart]) { //look up the book part in the book.json
            ...
            var bodyText =  '**Not found**\ntry: `/yoga  1.1`'; ////<----CHANGE THE EXAMPLE of what a 'proper' call to this command looks like
        }
