"""The 78 Rider-Waite-Smith tarot card image URLs, in canonical order.

Order: 22 Major Arcana, then Wands, Cups, Swords, Pentacles -- each suit
running King, Queen, Knight, Page, Ten..Two, Ace. Copied verbatim from the
original Node.js bot.
"""
